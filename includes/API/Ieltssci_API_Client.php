...
class Ieltssci_API_Client {
	 ...
	 * @param string|array $transcript_json The transcript JSON data as string or array.
	 * @return array|WP_Error The assessment result or WP_Error on failure.
	 *
	 * @throws Exception If API call fails.
	 */
	public function make_pronunciation_assessment_api_call( $audio_file_path, $transcript_json ) {
		try {
			...
			// Ensure transcript_json is a string.
			if ( is_array( $transcript_json ) ) {
				$transcript_json = wp_json_encode( $transcript_json );
			}
